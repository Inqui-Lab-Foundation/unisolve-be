...
describe("mentor test cases", () => {
    describe("mentor: create the mentor", () => {
        ...
        test("Should return 200 & create account", async () => {
            ...
            expect(res.body).toHaveProperty("mentor_name");
    ...
    describe("mentor: get the single mentor", () => {
        ...
        test("Should return 200", async () => {
            ...
            jest.spyOn(mentorService, "findMentor").mockImplementation(() => mockCreateIntenseCourse())
            const res = await supertest(app)
    ...
    describe("mentor: update the single mentor", () => {
        ...
        test("Should return 200", async () => {
            ...
            jest.spyOn(mentorService, "updateMentor").mockImplementation(() => mockCreateIntenseUpdate());
            const res = await supertest(app)
    ...
    describe("mentor: delete the single mentor", () => {
        ...
        test("Should return 200", async () => {
            ...
            jest.spyOn(mentorService, "findMentor").mockImplementation(() => mockCreateIntenseCourse())
            jest.spyOn(mentorService, "destroyMentor").mockImplementation(() => mockCreateIntenseDelete())
            const res = await supertest(app)
            ...
            expect(mockCreateIntenseCourse).toHaveBeenCalledTimes(1);
            expect(res.status).toBe(200)
            expect(res.body).toHaveProperty("deleteMentor")
