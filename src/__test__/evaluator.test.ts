...
import evaluatorService from "../services/operational.services";
...
describe("evaluator test cases", () => {
    ...
    describe("evaluator: get the single evaluator", () => {
        ...
        test("Should return 200", async () => {
            ...
            jest.spyOn(evaluatorService, "findOne").mockImplementation(() => mockCreateIntenseCourse())
            const res = await supertest(app)
    ...
    describe("evaluator: update the single evaluator", () => {
        ...
        test("Should return 200", async () => {
            ...
            jest.spyOn(evaluatorService, "findOne").mockImplementation(() => mockCreateIntenseCourse())
            jest.spyOn(evaluatorService, "updateOne").mockImplementation(() => mockCreateIntenseUpdate());
            const res = await supertest(app)
    ...
    describe("evaluator: delete the single evaluator", () => {
        ...
        test("Should return 200", async () => {
            ...
            jest.spyOn(evaluatorService, "findOne").mockImplementation(() => mockCreateIntenseCourse())
            jest.spyOn(evaluatorService, "destroyOne").mockImplementation(() => mockCreateIntenseDelete())
            const res = await supertest(app)
