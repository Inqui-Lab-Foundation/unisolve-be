...
describe("API - AdminChangePassword", () => {
    ...
    test("return 202 change the password", async () => {
        ...
        const res = await request(app).put("/api/v1/admin/changePassword").send(changePassword).set("Authorization", "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..vC0zUP3zUAsOBNp-Hg6Hl-_2hleFAJptyTnBQYRGR9u6VmtZ2OTPgJRKu84T5Eg0wYjt2d6ANFRg7aE4lVhpu4ndmpdFBrEuIDp_dClK6lsFDVrif5QGmu0afHcrR1b6YBmN-_w0C-d__rQQr9WSZZvT40kP22So0nFtUwOGXqY")
        expect(mockCreateIntense).toHaveBeenCalledTimes(1);
