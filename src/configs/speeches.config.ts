...
export const speeches = {
    ...
    MENTOR_EXISTS: "Not Acceptable, Email ID already exists",
    MOBILE_EXISTS: "Not Acceptable, Mobile Number already exists",
    ...
    STUDENT_DETAILS_NOT_FOUND: "Student details not found",
    TEAM_DETAILS_NOT_FOUND: "Team details not found",
